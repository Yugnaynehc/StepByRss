...
public class DBUtil {
	...
	public static ArrayList<String> getWanted() {
	...
	public static ArrayList<String> addComment(String ID, String info,
			String usernamea) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
	...
	public static String addReport(String username, String sbsname,
			String reason, String usernamea, String ID) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
	...
	public static String addWanted(String username, String sbsname, String mark) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("wanted", arrayList, brrayList);
		return crrayList.get(0);
	}

	public static void setUserEmailAddress(String username, String email) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Resetemail", arrayList, brrayList);
	}
	...
	public static String getUserEmailAddress(String username) {
		...
		crrayList = Soap.GetWebServre("Getemail", arrayList, brrayList);
		return crrayList.get(0);
	}

	public static void setUserHobby(String username, String hobby) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Resethobby", arrayList, brrayList);
	}

	public static String getUserHobby(String username) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Gethobby", arrayList, brrayList);
		return crrayList.get(0);
	}

	public static String setUserNickName(String username, String nickname) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		brrayList.add(nickname);

		crrayList = Soap.GetWebServre("Resetnickname", arrayList, brrayList);
		return crrayList.get(0);
	}
	...
	public static String getUserNickName(String username) {
		...
		crrayList = Soap.GetWebServre("Getnickname", arrayList, brrayList);
		return crrayList.get(0);
	}

	public static void setUserSignaure(String username, String signaure) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		arrayList.add("username");
		brrayList.add(username);
		arrayList.add("signaure");
		brrayList.add(signaure);

		crrayList = Soap.GetWebServre("Resetsignaure", arrayList, brrayList);
	}

	public static String getUserSignaure(String username) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
	...
	public static void setUserTele(String username, String tele) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Resettele", arrayList, brrayList);
	}

	public static String getUserTele(String username) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Gettele", arrayList, brrayList);
		return crrayList.get(0);
	}

	public static void setKnowledgeOutline(String ID, String name,
			String descr, String tool) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Retsetsbsname", arrayList, brrayList);
	}

	public static void setKnowledgeDetail(String ID, String time, String info) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		crrayList = Soap.GetWebServre("Resetsbs", arrayList, brrayList);
	}

	public static void setKnowledgePicture(String id, String phoinfo,
			String time, String length) {
		arrayList.clear();
		brrayList.clear();
		crrayList.clear();
		...
		arrayList.add("id");
		brrayList.add(id);
		arrayList.add("phoinfo");
		brrayList.add(phoinfo);
		arrayList.add("time");
		brrayList.add(time);
		arrayList.add("length");
		brrayList.add(length);

		crrayList = Soap.GetWebServre("Resetpho", arrayList, brrayList);
	}
}
