...
namespace TestWebService3
{
    ...
    public class Service1 : System.Web.Services.WebService
    {
       ...
       [WebMethod(Description = "获取图片（放在本地）")]
        ...
        [WebMethod(Description = "修改经验名称，概要，工具")]
        public bool Retsetsbsname(string id, string name, string descr, string tool)
        {
            return pub.Retsetsbsname(id,name,descr,tool);
        }
        [WebMethod(Description = "修改经验图片")]
        public bool Resetpho(string id, string phoinfo, string time, string length)
        {
            return pub.Resetpho(id,phoinfo,time,length);
        }
        [WebMethod(Description = "经验总数")]
        public int countsbs()
        {
            return com.countsbs();
        }
        //[WebMethod(Description = "删除节点")]
       // public bool deletenode(string id)
        //{
            //return pub.deletenode(id);
        //}
